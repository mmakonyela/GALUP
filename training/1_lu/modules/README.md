...
> **Instructor**: [Dr. Changjie Chen](https://github.com/chjch) (<ins>chj.chen@<i></i>ufl.edu</ins>).&nbsp;&nbsp;&nbsp;&nbsp;**Date**: November 22-24, 2023
...
4. [Module 4 - Making Land-Use Decisions using the LUCIS Framework](module.md)
